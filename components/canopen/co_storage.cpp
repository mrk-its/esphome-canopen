...
CO_ERR   StoreCommParamsInit (CO_OBJ *obj, CO_NODE *node) {
    return CO_ERR_NONE;
}
...
uint32_t ResetCommParamsSize (CO_OBJ *obj, CO_NODE *node, uint32_t width) {
    return CO_ERR_OBJ_READ;
}

CO_ERR ResetCommParamsInit (CO_OBJ *obj, CO_NODE *node) {
    return CO_ERR_NONE;
}
